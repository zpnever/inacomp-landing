...
const Division = () => {
	return (
		<section id="division" className="relative pt-18 pb-10 overflow-hidden">
			{/* Background */}
			<img
				src="divisionAssets/bgLeft.svg"
				alt="bgLeft.svg"
				className="absolute md:left-0 w-40 md:w-60 -z-10 -left-9 top-0"
			/>
			<img
				src="divisionAssets/bgRight.svg"
				alt="bgRight.svg"
				className="absolute md:right-0 w-60 md:w-90 -z-10 -right-15 top-0"
			/>
			...
			<div className="flex flex-col items-center justify-center">
				<div className="text-center w-[60%] md:px-0">
					...
					<p
						id="daftar"
						className="text-thirt-black mt-4 opacity-60 font-light text-[15px] max-w-2xl mx-auto"
					>
				...
				<div className="flex flex-col md:flex-row mt-16 md:mt-20 gap-8 px-6 md:px-[100px]">
					{/* Card 1 */}
					<div className="border w-full bg-white md:w-1/2 rounded-xl shadow-md p-8 shadow-gray-300 flex flex-col items-center justify-between text-center border-gray-200">
						<img
						...
						<p className="text-thirt-black opacity-60 font-light text-[15px] leading-7">
							Kompetisi ini mengasah logika dan kemampuan pemrograman peserta
						...
						<a href="https://forms.gle/zqGmy2QEgUYMeuTD8" target="_blank">
					...
					{/* Card 2 */}
					<div className="border w-full bg-white md:w-1/2 rounded-xl shadow-md p-8 justify-between shadow-gray-300 flex flex-col items-center text-center border-gray-200">
						<img
						...
						<a href="https://forms.gle/bRpja6SmgLpds9ZD6" target="_blank">
							<button className="bg-button-header mt-8 cursor-pointer font-bold border-3 border-button-header text-white py-3 px-6 text-[14px] rounded-lg hover:bg-white hover:border-button-header hover:text-button-header transition-colors duration-300">
								DAFTAR SEKARANG
							</button>
						</a>
